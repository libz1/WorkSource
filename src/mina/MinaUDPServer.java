...
// 服务器、客户端、serial
public class MinaUDPServer implements Observer{

	private SerialServerHandlerByte handle;
	NioDatagramAcceptor connector = null;
	...
	public MinaUDPServer(SerialParam s) {
		Util698.log(MinaUDPServer.class.getName(), "开启UDP Server:"+s.getCOMM() +"-"+s.getBaudRate(), Debug.LOG_INFO);
...
//			Publisher.getInstance().publish(s);
	...
	public static void main(String[] args) {
		...
		MinaUDPServer minaUDPServer = new MinaUDPServer(s);
