...
public class BarCodeCURD extends Application{
	public BarCodeCURD(){
	...
	private void init0() {
		...
		Scene scene = null;
		{
			...
			try {
				// 界面布局放在fxml文件中
				// 控件的事件代码在controler类中
				URL location = getClass().getResource("BarCode.fxml");
		        ...
		        BarCodeCURDController control=(BarCodeCURDController)fxmlLoader.getController();
