...
public class Frame645Meter {
	...
	// 构造函数，根据645报文，得到对象
	public Frame645Meter(String frame, String coll_param, String suffix) {
...
////			}
//		}
		// xuky 2018.11.12 自定义格式的645报文，数据域部分不倒序不加33H
		aData = Data;
		getDataLen();
	...
	public String getDataLen() {
		...
		if (Coll.equals(""))
			...
			num = Data.length() / 2 + 6;
		// xyky 2018.11.12 数据长度为2字节
		if (num != 0)
			num = num - 4 ; // 不含数据标示的长度
		DataLen = "0000" + Integer.toHexString(num);
		DataLen = DataLen.substring(DataLen.length() - 4, DataLen.length());
	...
	public static void main(String[] args) {
		// String str = "6812000000000068D101803416";
		// Frame645 f = new Frame645(str);
		// System.out.println(f.Addr);
		// System.out.println(f.Control);
		// System.out.println(f.Data);
		// System.out.println(f.Data_item);
		// System.out.println(f.getData_data());
		// System.out.println(f.DataLen);
		Frame645Meter frame645 = new Frame645Meter();
		frame645.setAddr("1");
		frame645.setControl("01");
		frame645.setData("9010");
		frame645.setColl("2");
