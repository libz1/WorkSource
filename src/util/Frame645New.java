...
public class Frame645New {
	...
	// 构造函数，根据645报文，得到对象
	public Frame645New(String frame, String coll_param, String suffix) {
...
//			aData = formatData(Data);
	...
	public static void main(String[] args) {
		...
		String addr = "0000";
			addr+=DataConvert.int2HexString(192, 2);
			addr+=DataConvert.int2HexString(168, 2);
			addr+=DataConvert.int2HexString(127, 2);
			addr+=DataConvert.int2HexString(96, 2);
		frame645.setAddr(addr);
		frame645.setControl("14");
//		frame645.setData_item("04969605");
		frame645.setData_item("04969603");
		System.out.println(frame645.get645Frame());


////		String frame = "68 13 30 04 22 17 20 68 1F 10 87 86 87 83 3E 34 33 33 33 33 33 34 37 3A 63 76 A5 16";
//		String frame = "68 12 00 00 00 00 00 68 1F 05 87 86 87 63 33 30 16";
//		frame = frame.replaceAll(" ", "");
//		System.out.println(frame);
//		Frame645New frame645 = new Frame645New(frame,"","");
////		Frame645New frame645 = new Frame645New();
//		String id = "43300704010000000000010B";
//		frame645.setControl("1F");
//		frame645.setAddr("000000000012");
//		frame645.setData_data("00");
//		frame645.setData_item("30545354");
//		frame645.setAddr("201722043013");
////		frame645.setData_item("50545354");
////		frame645.setData_data(id);
//		System.out.println(frame645.get645Frame());
