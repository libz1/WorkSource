...
import produce.deal.DealTestCase1;

// 对象池 xuky 2018.03.22
// 参考http://blog.csdn.net/shimiso/article/details/9814917
// 调整代码Bug，调整为整体的单例对象
public class ObjectPoolDealTestCase1 {
	private volatile static ObjectPoolDealTestCase1 uniqueInstance;
	...
	public static ObjectPoolDealTestCase1 getInstance() {
		if (uniqueInstance == null) {
			synchronized (ObjectPoolDealTestCase1.class) {
				if (uniqueInstance == null) {
					// 双重检查加锁
					uniqueInstance = new ObjectPoolDealTestCase1();
				}
			}
		}
	...
	private ObjectPoolDealTestCase1() {
		createPool();
	}
