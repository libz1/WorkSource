...
public class TreeNode {
	...
	public TreeNode(String key, String value) {
		...
		// xuky 2017.03.04 添加了分隔信息会影响数据的展示
...
//		else
	...
	public TreeNode find_child(String key) {
		return find_child( key,false );
	}
		// 根据key得到节点
	public TreeNode find_child(String key, Boolean all) {
		TreeNode node = null;
	...
	public TreeNode convetFromString(String jsonData) {
		return new Gson().fromJson(jsonData, new TypeToken<TreeNode>() {
		}.getType());
	}
